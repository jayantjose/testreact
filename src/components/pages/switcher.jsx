...
import Pageheader from '../layout/layoutcomponents/pageheader';
import * as SwitcherData from '../../common/switcherdata';
import { Card, Container, Row, Col } from 'react-bootstrap';
import { connect } from "react-redux";

const Switcher = ({ SwitcherAction, changePrimaryColor, darkPrimaryColor, transparentBackground, BGImagePrimaryColor }) => {
										...
										<Row className="row-sm">
											<div className="predefined_styles text-start">
												<div className="swichermainleft">
													<h5 className="py-3 bd-y border-top-0 mb-0">LTR AND RTL VERSIONS</h5>
